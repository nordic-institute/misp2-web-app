...
var CodeMirror = (function(){
  ...
  CodeMirror.prototype = {
    ...
    /**
     * Added by Arnis Rips on 7.07
     * Reloads current editor contents from source textare content
     * If area is "code" then acts similar to setCode method
     */
    reloadContent: function(area) {
        if (typeof area == "string")
            area = document.getElementById(area);
        this.setCode(area.value)
    },
