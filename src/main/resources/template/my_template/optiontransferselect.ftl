...
<div class="arrows">
    <#if parameters.allowAddToLeft?default(true)><#t/>
        ...
        <#else><#t/>
                    ...
                    <a href="#" onclick="moveSelectedOptions(document.getElementById('${parameters.doubleId?html}'), document.getElementById('${parameters.id?html}'), false, '');<#if parameters.addToLeftOnclick?has_content>${parameters.addToLeftOnclick};</#if> return false;" >
                        <img width="17" height="22" alt="" src="resources/${subPortal}/images/arrow-left-single.png" />
                    </a>
                    <br /><br />
                </#if><#t/>
    ...
    <#if parameters.allowAddToRight?default(true)><#t/>
        ...
        <#else><#t/>
                    ...
                    <a href="#" onclick="moveSelectedOptions(document.getElementById('${parameters.id?html}'), document.getElementById('${parameters.doubleId?html}'), false, '');<#if parameters.addToRightOnclick?has_content>${parameters.addToRightOnclick};</#if> return false;" >
                        <img width="17" height="22" alt="" src="resources/${subPortal}/images/arrow-right-single.png" />
                    </a>
                    <br /><br />
    ...
    <#if parameters.allowAddAllToLeft?default(true)><#t/>
        ...
        <#else><#t/>
                    ...
                    <a href="#" onclick="moveAllOptions(document.getElementById('${parameters.doubleId?html}'), document.getElementById('${parameters.id?html}'), false, '');<#if parameters.addAllToLeftOnclick?has_content>${parameters.addAllToLeftOnclick};</#if> return false;" >
                        <img width="29" height="22" alt="" src="resources/${subPortal}/images/arrow-left-double.png" />
                    </a>
                    <br /><br />
    ...
    <#if parameters.allowAddAllToRight?default(true)><#t/>
        ...
        <#else><#t/>
                    ...
                    <a href="#" onclick="moveAllOptions(document.getElementById('${parameters.id?html}'), document.getElementById('${parameters.doubleId?html}'), false, '');<#if parameters.addAllToRightOnclick?has_content>${parameters.addAllToRightOnclick};</#if> return false;"  >
                        <img width="29" height="22" alt="" src="resources/${subPortal}/images/arrow-right-double.png" />
                    </a>
                    <br /><br />
