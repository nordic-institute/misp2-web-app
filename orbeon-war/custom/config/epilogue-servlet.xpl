                    ...
                    <p:processor name="oxf:xslt">
                           <p:input name="config">
                                   <xsl:transform version="2.0">
                                           ...
                                           <xsl:template match="*:div[@id='orbeon-inspector']"/>                                            
                                           <xsl:template match="*:button"/>
                                           <xsl:template match="*:span[contains(@class, 'xforms-disabled')] | *:span[contains(@class, 'xforms-initially-hidden')] | *:div[contains(@class, 'xforms-disabled')] | *:div[contains(@class, 'xforms-initially-hidden')]"/>
                           ...
                           <p:output name="data" id="processed-data"/>
                   </p:processor>
                </p:when>
                <p:otherwise>
                    <!-- No rewriting -->
                    ...
                    <p:choose href="#request">
                        <p:when test="contains(/request/headers/header[name = 'accept'], 'application/xhtml+xml')">
                            <p:processor name="oxf:plain-xhtml-converter">
                                <p:input name="data" href="#processed-data"/>
